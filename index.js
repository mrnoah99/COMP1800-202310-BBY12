...
// const datasetFolderPath = './dataset';
// const gamesMetadataFilePath = path.resolve(datasetFolderPath, 'games_metadata.json');
// app.get('/popular', (req, res) => {
//   const datasetFolderPath = './dataset';
//   const gamesMetadataFilePath = path.resolve(datasetFolderPath, 'games_metadata.json');

//   const gamesMetadataData = fs.readFileSync(gamesMetadataFilePath, 'utf-8');
//   const gamesMetadata = JSON.parse(gamesMetadataData);

//   const popularGames = gamesMetadata.filter(game => game.popularity === 'popular');

//   res.render('popular', { games: popularGames });
// });
